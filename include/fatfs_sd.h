...
#define FATFS_USE_DETECT_PIN_RCC			RCC_AHB1Periph_GPIOA			
...
#define FATFS_USE_WRITEPROTECT_PIN_RCC		RCC_AHB1Periph_GPIOA			
#define FATFS_USE_WRITEPROTECT_PIN_PORT		GPIOA
